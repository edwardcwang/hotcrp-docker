...
$Opt["dbName"] = getenv('MARIADB_DBNAME');
$Opt["dbUser"] = getenv('MARIADB_USER');
$Opt["dbPassword"] = getenv('MARIADB_PASSWORD');
...
$Opt["contactEmail"] = "sender@example.localdomain";
$Opt["internalMailer"] = true;
$Opt["sendEmail"] = true;
$Opt["emailFrom"] = "sender@example.localdomain";
$Opt["emailSender"] = "sender@example.localdomain";
...
$Opt["dbHost"] = getenv('MARIADB_HOST');
